...
// We save the index of current server and on the next request we move the next server in line
...
func loadbalancer(w http.ResponseWriter, r *http.Request) {
	...
	log.Printf("Server Selected --------- %s", peer.URL)
	if peer != nil {
...
func main() {
	...
	// make a Reverse Proxy for each server
	for _, server := range serverList {
		...
		proxy.ErrorHandler = func(writer http.ResponseWriter, request *http.Request, e error) {
			...
			// basically  we are saving the value of Attempts in the Context and Using it in loadbalancer func
